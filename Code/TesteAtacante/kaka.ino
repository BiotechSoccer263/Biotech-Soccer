...
Ultrasonic UltraF(29, 28);  // Ultrassônico Frente
Ultrasonic UltraE(41, 40);  // Ultrassônico Esquerda
Ultrasonic UltraD(42, 43);  // Ultrassônico Direita
Ultrasonic UltraT(44, 45);  // Ultrassônico Atrás
const int ParedeT = 18;     // Distância Parede Atrás
...
const int Curvas = 70;   // Velocidade para Curvas
const int Correr = 220;  // Velocidade para Correr

int BrancoMin = 50;   // Valor Branco Mínimo
int BrancoMax = 200;  // Valor Branco Máximo
